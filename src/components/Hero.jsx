...
const Hero = () => {
  ...
  return (
    <div className="text-center bg-white text-gray-800 py-32 px-6">
      <h1
      ...
      <div className="flex justify-center items-center space-x-2">
        ...
        <button
          type="button"
          className="inline-block px-8 py-3 border border-green-600
        font-medium text-md leading-tight uppercase text-green-600
